...
/**
 *
 * Main class to simulate voting using BlockChain via P2P network.
 *
 */
public class Main {

    private static final String DEFAULT_SERVER_ADDR = "192.168.176.104";
    private static final int DEFAULT_PORT = 6777;

    
    public static void main(String[] args) {

        System.out.println("\t ---------- B-CHAIN VOTES : Voting System Based On BlockChain Technology ---------- \n");
        
        System.out.println(" ----- MAIN MENU ----- \n");
        System.out.println("1. Cast Votes");
        System.out.println("2. View Votes in the Blockchain");
        System.out.println("3. Count the Votes");
        ...
        if(ch == 1)
        {
            ...
            System.out.println("ATTENTION : Make sure to run the Server first and then connect the Client to it.");
            System.out.println("\t ------------------------- \n");
        ...
        else if(ch == 2)
        {
            ...
            String fileName;
            fileName=userHomePath+"/NetBeansProjects/Blockchain Voting System/src/blockchain_data";
            File f=new File(fileName);

            try
            {
                if(!f.exists())
                    System.out.println("Blockchain File Not Found... Cast your votes first !");
                else{
        ...
        else if(ch == 3)
        {
            ...
            try
            {
                ...
                else
                {
                    System.out.println();
                    System.out.println("-------------------------");
                    System.out.println("Vote Count from the Blockchain : ");
                    ObjectInputStream in=new ObjectInputStream(new FileInputStream(fileName));
            ...
            System.out.println("Thank you for using B-Chain Votes !");
            exit(0);
        }
    }

    public static void showHelp() {
        System.out.println("Restart and select your role as Server or Client.");
        exit(0);
    }
